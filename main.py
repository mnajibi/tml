...
def process_file(file_path, lang, output_dir):
    ...
    if file_path.endswith('.txt'):
        updated_content, broken_links = replace_links(file_path, content, is_markdown=False)
        ...
        updated_content, broken_links = replace_links(file_path, content, is_markdown=True)
